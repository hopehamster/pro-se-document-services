// Modified script to retry the texture generation with a VERY different prompt to avoid Recitation filter
const fs = require('fs');
...
async function main() {
    ...
    // Prompt changed significantly to avoid matching "copyrighted" noise textures
    const tasks = [
        {
            prompt: "black and white macro photography of slate stone surface, rough natural texture, extreme close up, organic pattern",
            aspectRatio: "16:9",
